(defproject polls "0.1.0-SNAPSHOT"
  ...
  :source-paths ["src/backend/app" "src/backend/components" "src/frontend" "src/db"]
  ...
  :aliases {"ci"                       ["do" "clean," "cloverage," "lint," "uberjar"]
            ...
            "release"                  ["with-profile" "prod" "do"
                                        ["shadow" "release" "app"]]
            "migrations.create"        ["run" "-m" "framework.db.migrations/create"]
            "migrations.migrate"       ["run" "-m" "framework.db.migrations/migrate"]
            "migrations.rollback-last" ["run" "-m" "framework.db.migrations/rollback-last"]
            "migrations.reset"         ["run" "-m" "framework.db.migrations/reset"]}
